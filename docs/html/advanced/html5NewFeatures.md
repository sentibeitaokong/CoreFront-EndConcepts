...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div
      id="messages"
      style="border: 1px solid #ccc; height: 200px; overflow-y: scroll; padding: 10px;"
    ></div>
...
<html lang="zh-CN">
  ...
  <body>
    <h2>History API</h2>
    <button onclick="changePage('page1', 'Page One Title', '/page1')">
      加载 Page 1
    </button>
    <button onclick="changePage('page2', 'Page Two Title', '/page2')">
      加载 Page 2
    </button>
    <div id="content"></div>
