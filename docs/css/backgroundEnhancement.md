...
![Logo](/img/backgroundPosition.png)
...
![Logo](/img/backgroundClipFirst.png)

![Logo](/img/backgroundClipSecond.png)
...
.card {
  background-image:
    ...
    /* 第一层：半透明遮罩 */ url('icon.png'),
    /* 第二层：小图标 */ url('photo.jpg'); /* 第三层：底图 */
...
### 3.1 怎么实现背景图片的“视差滚动”效果 (Parallax)？
