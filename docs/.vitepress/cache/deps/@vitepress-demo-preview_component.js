...
// ../node_modules/.pnpm/@vitepress-demo-preview+component@2.6.2_vitepress@1.6.4_@algolia+client-search@5.50.2_@_e84daffadbee1c73efb0bca8b59e9ce5/node_modules/@vitepress-demo-preview/component/dist/preview-component.js
...
var On = defineComponent({
  ...
  setup(e, { emit: t }) {
    const o = e,
      ...
      Y = computed(() => X.value * o.gap + Z.value || 0),
      h = computed(() => {
        var d
    ...
    function nt() {
      ...
      const d = Number(
          ((q = w.value) == null
            ? void 0
            : q.style.getPropertyValue('--swipe-amount-x').replace('px', '')) ||
            0,
        ),
        F = Number(
          ((we = w.value) == null
      ...
      if (Math.abs(I) >= An || V > 0.11) {
        ...
        (($e = w.value) == null ||
          ...
          (_e = w.value) == null ||
            _e.style.setProperty('--swipe-amount-y', '0px'))
    ...
    function it(d) {
      ...
      ;((Math.abs(q.x) > 0 || Math.abs(q.y) > 0) && (f.value = true),
        (_e = w.value) == null ||
          _e.style.setProperty('--swipe-amount-x', `${q.x}px`),
        (ze = w.value) == null ||
          ze.style.setProperty('--swipe-amount-y', `${q.y}px`))
    }
    ;(onMounted(() => {
          ...
          'li',
          {
            ...
            class: normalizeClass(
              unref(Te)(
                ...
                (we = (q = d.toast) == null ? void 0 : q.classes) == null
                  ? void 0
                  : we[p.value],
              ),
            ),
            ...
            'data-expanded': Boolean(
              d.expanded || (d.expandByDefault && r.value),
            ),
                  ...
                  [
                      ...
                      ? (openBlock(),
                        createElementBlock(
                          'div',
                          {
                            ...
                            class: normalizeClass(
                              unref(Te)(
                                (Ct = d.classes) == null ? void 0 : Ct.icon,
                                (Xt =
                                  (Gt = d.toast) == null
                                    ? void 0
                                    : Gt.classes) == null
                            ...
                            d.toast.icon
                              ...
                              : (openBlock(),
                                createElementBlock(
                                  ...
                                  [
                                    p.value === 'loading'
                                      ? renderSlot(d.$slots, 'loading-icon', {
                                          key: 0,
                                        })
                                      : p.value === 'success'
                                        ? renderSlot(d.$slots, 'success-icon', {
                                            key: 1,
                                          })
                                        : p.value === 'error'
                                          ? renderSlot(d.$slots, 'error-icon', {
                                              key: 2,
                                            })
                                          : p.value === 'warning'
                                            ? renderSlot(
                    ...
                    createBaseVNode(
                      'div',
                      {
                        ...
                        class: normalizeClass(
                          unref(Te)(
                            (Kt = d.classes) == null ? void 0 : Kt.content,
                            (Jt =
                              (Qt = d.toast) == null ? void 0 : Qt.classes) ==
                              null
                              ? void 0
                              : Jt.content,
                          ),
                      ...
                      [
                        createBaseVNode(
                          'div',
                          {
                            ...
                            class: normalizeClass(
                              unref(Te)(
                                (eo = d.classes) == null ? void 0 : eo.title,
                          ...
                          [
                            K.value
                              ? (openBlock(),
                                createBlock(
                                  resolveDynamicComponent(d.toast.title),
                                  normalizeProps(
                                    mergeProps(
                                      { key: 0 },
                                ...
                                Q.value
                                  ...
                                  : (openBlock(),
                                    createElementBlock(
                                      ...
                                      [
                                        createTextVNode(
                                          toDisplayString(d.toast.description),
                                          1,
                                        ),
                                      ],
                                      64,
                      ...
                      ? (openBlock(),
                        createElementBlock(
                          'button',
                          {
                            key: 1,
                            style: normalizeStyle(
                              d.toast.cancelButtonStyle || d.cancelButtonStyle,
                            ),
                            class: normalizeClass(
                              unref(Te)(
                                (io = d.classes) == null
                      ...
                      ? (openBlock(),
                        createElementBlock(
                          'button',
                          {
                            key: 2,
                            style: normalizeStyle(
                              d.toast.actionButtonStyle || d.actionButtonStyle,
                            ),
                            class: normalizeClass(
                              unref(Te)(
                                (ao = d.classes) == null
...
var ci = defineComponent({
  ...
  setup(e) {
    ...
    const s = computed(() => {
        ...
        return h.length > 0
          ? Array.from(new Set([t.position].concat(h)))
          : [t.position]
      }),
      r = computed(() => {
        const h = {}
    ...
    function w(h) {
      var b
      ;(((b = n.value.find(C => C.id === h.id)) != null && b.delete) ||
        oe.dismiss(h.id),
    ...
    ;(watchEffect(h => {
      ...
      watchEffect(() => {
        m.value &&
          y.value &&
          (y.value.focus({ preventScroll: true }),
          (y.value = null),
          (v.value = false))
      }),
      watchEffect(() => {
                            ...
                            return (
                              ...
                              createBlock(
                                Hn,
                                {
                                  ...
                                  position: C,
                                  style: normalizeStyle(
                                    (ot = h.toastOptions) == null
                                      ? void 0
                                      : ot.style,
                                  ),
                                  unstyled:
                                    (nt = h.toastOptions) == null
                                      ? void 0
                                      : nt.unstyled,
                                  classes:
                                    (it = h.toastOptions) == null
                                      ? void 0
                                      : it.classes,
                                  cancelButtonStyle:
                                    (st = h.toastOptions) == null
                                      ? void 0
...
function yi(e, t, o, n) {
  ...
  return (
    i && ((s = s.map(r => r + '-' + i)), t && (s = s.concat(s.map(ht)))),
    s
  )
}
function ft(e) {
  ...
  const { x: n, y: i, platform: s, rects: r, elements: a, strategy: l } = e,
    ...
    u = Ze(
      await s.getClippingRect({
        element:
          (o = await (s.isElement == null ? void 0 : s.isElement(x))) == null ||
          o
            ? x
            : x.contextElement ||
    ...
    p =
      m === 'floating'
        ...
        : r.reference,
    _ = await (s.getOffsetParent == null
      ? void 0
...
var $i = e => ({
  ...
  async fn(t) {
    ...
    let Z = X ? X[_] : 0
    ;(!Z || !(await (r.isElement == null ? void 0 : r.isElement(X)))) &&
      (Z = a.floating[_] || s.floating[$])
    const Y = H / 2 - E / 2,
      h = Z / 2 - w[$] / 2 - 1,
      b = Ke(m[u], h),
      C = Ke(m[p], h),
    ...
    e === void 0 && (e = {}),
    {
      ...
      async fn(t) {
        ...
        let Z = H,
          Y = E
        if (
          ((o = t.middlewareData.shift) != null && o.enabled.x && (Y = _),
          (n = t.middlewareData.shift) != null && n.enabled.y && (Z = p),
          X && !y)
        ) {
          const b = Ee(f.left, 0),
            C = Ee(f.right, 0),
            ...
            O = Ee(f.bottom, 0)
          v
            ? (Y = $ - 2 * (b !== 0 || C !== 0 ? b + C : Ee(f.left, f.right)))
            : (Z = w - 2 * (B !== 0 || O !== 0 ? B + O : Ee(f.top, f.bottom)))
        }
        await l({
          ...t,
          availableWidth: Y,
...
function Qe(e, t, o, n) {
  ...
  let m =
      (r.left +
        ((f && ((i = c.visualViewport) == null ? void 0 : i.offsetLeft)) ||
          0)) /
      l.x,
    y =
      (r.top +
        ((f && ((s = c.visualViewport) == null ? void 0 : s.offsetTop)) || 0)) /
      l.y,
    v = r.width / l.x,
    $ = r.height / l.y
  if (a) {
...
function ke(e) {
  return ((Io(e) ? e.ownerDocument : e.document) || window.document)
    .documentElement
}
function yt(e) {
  return Be(e)
...
function gt(e, t) {
  ...
  const n = Uo(e),
    ...
    s = se(n)
  return i
    ? t.concat(s, s.visualViewport || [], wt(n) ? n : [])
    : t.concat(n, gt(n))
}
function Hi(e, t) {
  const o = se(e),
...
function Co(e) {
  const t = se(e)
  let o = bo(e)
  for (; o && Li(o) && ue(o).position === 'static'; ) o = bo(o)
  return o &&
    (Pe(o) === 'html' ||
      (Pe(o) === 'body' && ue(o).position === 'static' && !Zt(o)))
    ? t
    : o || zi(e) || t
}
function Fi(e, t, o) {
    ...
    methods: {
        ...
        if (
          (t
            ? e.middleware.push(
                Ti({
                  alignment:
                    (n = this.placement.split('-')[1]) != null ? n : '',
                }),
              )
      ...
      $_scheduleShow(e, t = false) {
        if (
          ...
          Le && this.instantMove && Le.instantMove && Le !== this.parentPopper)
        ) {
      ...
      async $_applyHide(e = false) {
        ...
        ;(t !== null &&
          (this.$_disposeTimer = setTimeout(() => {
            this.$_popperNode &&
              (this.$_detachPopperNode(), (this.isMounted = false))
          }, t)),
      ...
      $_removeEventListeners(e) {
        ...
        ;(this.$_events.forEach(o => {
          ...
          !e || e === i
            ? n.forEach(r => r.removeEventListener(i, s))
            : t.push(o)
        }),
          (this.$_events = t))
      },
    ...
    createElementBlock(
      ...
      [
        renderSlot(
          e.$slots,
          'default',
          normalizeProps(guardReactiveProps(e.slotData)),
        ),
      ],
      2,
    )
  ...
  return (
    ...
    createElementBlock(
      'div',
      {
        ...
        onKeyup:
          t[2] ||
          (t[2] = withKeys(a => e.autoHide && e.$emit('hide'), ['esc'])),
      },
      [
        createBaseVNode('div', {
...
defineComponent({
  ...
  methods: {
    ...
    onResult(e, t) {
      e === this.$_fetchId &&
        ((this.$_loading = false), (this.asyncContent = t))
    },
    onShow() {
  ...
  setup(e) {
    const t = e,
      ...
      v = () => {
        var p
        const u =
          (p = c.value) == null ? void 0 : p.closest('[class*="__container"]')
        if (u) {
                      ...
                      [
                        createVNode(
                          ...
                          { placement: 'bottom' },
                          {
                            popper: withCtx(() => [
                              createTextVNode(
                                toDisplayString(unref(r)('copyCode')),
                                1,
                              ),
                            ]),
                            default: withCtx(() => [
                          ...
                          ? (openBlock(),
                            createBlock(
                              ...
                              },
                              {
                                popper: withCtx(() => [
                                  createTextVNode(
                                    toDisplayString(unref(r)('expandCode')),
                                    1,
                                  ),
                                ]),
                                default: withCtx(() => [
                          ...
                          : (openBlock(),
                            createBlock(
                              ...
                              },
                              {
                                popper: withCtx(() => [
                                  createTextVNode(
                                    toDisplayString(unref(r)('foldCode')),
                                    1,
                                  ),
                                ]),
                                default: withCtx(() => [
