import{_ as i,o as a,c as n,ay as l}from"./chunks/framework.WiLnJcdu.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"js/inherit.md","filePath":"js/inherit.md","lastUpdated":1770369888000}'),p={name:"js/inherit.md"};function h(k,s,t,e,r,d){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h3 id="nativejs-inherit-js" tabindex="-1">NativeJs/inherit.js <a class="header-anchor" href="#nativejs-inherit-js" aria-label="Permalink to &quot;NativeJs/inherit.js&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//原型链继承   缺陷：引用类型的属性被所有实例共享  创建子实例无法向父实例传参</span></span>
