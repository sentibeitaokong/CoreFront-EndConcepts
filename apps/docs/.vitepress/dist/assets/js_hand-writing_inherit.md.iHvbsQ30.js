import{_ as n,b as l,e as p,al as h}from"./chunks/framework.DrQIcdFj.js";(function(){try{var s=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};s.SENTRY_RELEASE={id:"abf23ae41d8e9798d1084c6d3fd2516340828177"};var i=new s.Error().stack;i&&(s._sentryDebugIds=s._sentryDebugIds||{},s._sentryDebugIds[i]="7d9ad83b-3039-48b2-af9e-63a90afd066f",s._sentryDebugIdIdentifier="sentry-dbid-7d9ad83b-3039-48b2-af9e-63a90afd066f")}catch{}})();const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"js/hand-writing/inherit.md","filePath":"js/hand-writing/inherit.md","lastUpdated":null}'),t={name:"js/hand-writing/inherit.md"};function k(s,i,a,e,r,d){return l(),p("div",null,[...i[0]||(i[0]=[h(`<h3 id="nativejs-inherit-js" tabindex="-1">NativeJs/inherit.js <a class="header-anchor" href="#nativejs-inherit-js" aria-label="Permalink to &quot;NativeJs/inherit.js&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//原型链继承   缺陷：引用类型的属性被所有实例共享  创建子实例无法向父实例传参</span></span>
...
//# sourceMappingURL=js_hand-writing_inherit.md.iHvbsQ30.js.map
