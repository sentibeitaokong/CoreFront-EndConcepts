...
class ComputedRefImpl {
    dep;
    _getter;
    _dirty = true; //缓存标识 true：没有缓存值 false:有缓存值
    _value;
    _effect;
    constructor(getter) {
...
const queue = []; //组件更新队列
const activePreFlushCbs = []; //组件更新之前的队列
...
export { ReactiveEffect, computed, createApp, createVNode as createElementVNode, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, nextTick, provide, proxyRefs, reactive, readonly, ref, registerRuntimeCompiler, renderSlots, shallowReadonly, toDisplayString, unRef, watch };
